...
public class OutputHandler {
    ...
    public void showPassOrderSummary(StudyCafeSeatPass pass, StudyCafeLockerPass lockerPass) {
        System.out.println();
        ...
        int discountPrice = (int) (pass.getPrice() * discountRate);
        if (discountPrice > 0) {
            System.out.println("이벤트 할인 금액: " + discountPrice + "원");
        }

        int totalPrice = pass.getPrice() - discountPrice + (lockerPass != null ? lockerPass.getPrice() : 0);
